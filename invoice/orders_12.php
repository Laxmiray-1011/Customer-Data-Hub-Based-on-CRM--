...
<script src="selectstyle.js"></script> -->
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				...
			  				<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)"  data-search="true">			  						
			  						<?php
								...
								<!--<div class="container">
								<select id="productName<?php echo $x; ?>" placeholder="Select Your Favorite" data-search="true" class="form-control" name="productName[]" onchange="getProductData(<?php echo $x; ?>)">
								<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)"  data-search="true">
									<?php
			  							$productSql = "SELECT * FROM product WHERE active = 1 AND status = 1 ";
			  							$productData = $connect->query($productSql);
							...
							jQuery(document).ready(function($) {
								$('#productName<?php echo $x; ?>').selectstyle({
									width  : 400,
									height : 300,
									theme  : 'light',
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
						...
						<option value="4">Half Payment</option>
