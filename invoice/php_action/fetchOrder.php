...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	} // /else <li><a type="button" onclick="printOrder('.$orderId.')"> <i class="glyphicon glyphicon-print"></i> Print </a></li>
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
		...
		<li><a type="button" href="php_action/printOrder.php?orderId='.$orderId.'"> <i class="glyphicon glyphicon-print"></i> Download </a></li>
