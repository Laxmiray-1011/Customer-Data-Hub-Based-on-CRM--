...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Add Invoice
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Manage Invoice  bill
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Customer ID/Name</label>
			    <div class="col-sm-10">
				
				<select class="form-control" id="clientName" name="clientName" onchange="" >
			  						<option value="">Select Customer</option>
			  						<?php
			  							$productSql = "SELECT * FROM course";
			  							$productData = $connect->query($productSql);

			  							while($row = $productData->fetch_array()) {	
											$product_name =  $row['course_name'];
											$product = ucwords(strtolower($product_name));
											
			  								echo "<option value='".$row['course_id']."' id='changeProduct".$row['course_id']."'>ID: ".$row['course_id']." ".$product."</option>";
										 	} // /while 
			  	...
			  	<tbody>
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {	
											...
											$product = ucwords(strtolower($product_name));
			  								...
			  								echo "<option value='".$row['product_id']."' id='changeProduct".$row['product_id']."'>".$product."</option>";
										 	} // /while 

			  						?>
		  						</select>
								<script type="text/javascript">
								$("#productName<?php echo $x; ?>").chosen();
								</script>
			  				...
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onclick="getTotal(<?php echo $x ?>)" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
			  	...
			  	<tbody>
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
											...
											$product = ucwords(strtolower($product_name));
			  								...
			  								echo "<option value='".$row['product_id']."' id='changeProduct".$row['product_id']."' ".$selected." >".$product."</option>";
										 	} // /while 
			  				...
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onclick="getTotal(<?php echo $x ?>)" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" value="<?php echo $orderItemData['quantity']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
						...
						<option value="1" <?php if($data[12] == 4) {
				      		echo "selected";
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Remove Invoice</h4>
      </div>
