	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" name="form1" action="<?php echo base_url("index.php/Admin_login/get_form_data");?>" method="post">
					<span class="login100-form-title">
						Jay Laxmi Auto
					</span>
					

					<div class="wrap-input100" data-validate = "Enter Valid User Name">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<?php echo form_error('user_pass','<span class="help-block">','</span>'); ?>
					</div>
