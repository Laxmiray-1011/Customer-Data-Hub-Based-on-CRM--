                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">EDIT PAYMENTS DATA</h3>
                                </div>
                                <div class="card-body">

                                    <?php
                                    foreach ($contentpaymentdata as $result) {

                                        // echo "<pre>";
                                        // print_r($contentpaymentdata);
                                        // die("hcjisdhfjifh");
                                    ?>
                                        <form method="POST" action="<?php echo base_url("index.php/Autocontroller/editpaymentform"); ?>">
                                            <input id="billerid" name="billerid" type="hidden" value="<?php echo $billerid ?>" />
                                            <input id="customer_id" name="customer_id" type="hidden" value="<?php echo  $result->customer_id ?>" />
                                            
                                               <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="lastbilldueadd" name="lastbilldueadd" type="text" value="<?php echo $lastbilldue, set_value("lastbilldueadd") ?>" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="billdate" name="billdate" type="text" class="form-control datepicker" value="<?php echo $result->billdate,
                                                                                                                                                                        set_value("billdate") ?>" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="billnumber" name="billnumber" type="text" placeholder="name@example.com" value="<?php echo $result->billnumber,
                                                                                                                                                                set_value("billnumber") ?>" />
                                                <?php echo form_error('billnumber', '<div class="error">', '</div>')  ?>
                                                <label for="billnumber">Bill Number</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" onblur="addbilldue()" id="billamountadd" name="billamountadd" type="text" placeholder="Customer description" value="<?php echo $result->billamt,
                                                                                                                                                                                                set_value("billamountadd") ?>" />
                                                <?php echo form_error('billamountadd', '<div class="error">', '</div>') ?>
                                                <label for="billamountadd">Bill Amount</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" onblur="addbilldue()" id="totalpaymentadd" name="totalpaymentadd" type="text" placeholder="Please enter address" value="<?php echo $result->totalpay, set_value("totalpaymentadd") ?>" />
                                                <?php echo form_error('totalpaymentadd', '<div class="error">', '</div>') ?>
                                                <label for="totalpaymentadd">Total Payments</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="billdescription" name="billdescription" type="text" placeholder="Please enter address" value="<?php echo $result->billdesc,
                                                                                                                                                                                    set_value("billdescription") ?>">
                                             </textarea>
                                                <?php echo form_error('billdescription', '<div class="error">', '</div>') ?>
                                                <label for="billdescription">Bill Description</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="billdueadd" name="billdueadd" type="text" placeholder="Please enter address" value="<?php echo $result->billdue, set_value("billdueadd") ?>" />
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?php echo site_url("Autocontroller/customer_paymentview_list?pay=".$result->customer_id)?>"   class="btn btn-sm btn-danger">CANCEL</a></div>
                                </div>
    ...
    <script type="text/javascript">
        function addbilldue($billerid) {
            ...
            if ((billamountadd == '') && (totalpaymentadd == '')) {
                //var sum = parseInt(totalpaymentadd) + parseInt(lastbilldueadd);	
                //var total = parseInt(sum) - parseInt(totalpaymentadd) ;
                document.getElementById('billdueadd').value = lastbilldueadd;
